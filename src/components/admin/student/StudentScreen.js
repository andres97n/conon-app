...
import { RowStudentExpansionApp } from './RowStudentExpansionApp';

import { 
    startDeleteManyStudents, 
    startDeleteStudent, 
    startLoadStudents, 
    startRemoveStudents, 
    startSaveStudent, 
...
export const StudentScreen = () => {
    ...
    const handleConfirmDeleteTeacher = ( data ) => {
        confirmDialog({
          message: '¿Está seguro que desea eliminar el siguiente Estudiante?',
    ...
    const handleConfirmDeleteManyTeachers = ( data ) => {
        confirmDialog({
          message: '¿Está seguro que desea eliminar los siguientes Estudiantes?',
          header: 'Confirmación de Eliminado',
          icon: 'fas fa-exclamation-triangle',
          acceptLabel: 'Sí, eliminar',
          rejectLabel: 'No eliminar',
          acceptClassName: 'p-button-danger',
          accept: () => handleStudentsDelete( data ),
        });
    }
