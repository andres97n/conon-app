...
import { TopicAssignAbpModeratorGroup } from './TopicAssignAbpModeratorGroup';


export const TopicAssignAbpStudentApp = React.memo(({
  topic,
  selectedStudents,
  toast,
  setSelectedStudents,
    ...
    <div className='p-grid crud-demo'>
      <div className='p-col-12'>
        <div className='grid p-fluid'>
          ...
          <TopicAssignAbpModeratorGroup 
            currentAbp={currentAbp}
