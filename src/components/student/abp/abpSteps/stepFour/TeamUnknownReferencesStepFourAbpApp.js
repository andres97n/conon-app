...
import { startBlockUnknownConceptReferenceStepFourAbp } from '../../../../../actions/student/abp_steps/unknownConceptStepFourAbp';


export const TeamUnknownReferencesStepFourAbpApp = React.memo(({
  teamReferences,
  userId,
  conceptId,
  ...
  const handleBlockConceptReference = ( referenceId ) => {
    ...
    dispatch( startBlockUnknownConceptReferenceStepFourAbp(
