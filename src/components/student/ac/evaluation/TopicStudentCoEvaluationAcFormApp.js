...
export const TopicStudentCoEvaluationAcFormApp = React.memo(({
  rubricDetailAc,
  values,
  setFieldValue,
  handleSubmit
  ...
  useEffect(() => {
    if (rubricDetailAc.length > 0) {
      const rubric = getCurrentSectionRubric( rubricDetailAc, 'Coevaluación' );
    ...
    <>
      <div className='col-12'>
        <h5 className='text-center'>
          ...
          Nota Final de la Coevaluación: {values.finalGrade}
        </h5>
      </div>
      <div className='col-12'>
        <h6 className='text-center'>
          Calificación que considere tiene en esta Coevaluación realizada
        </h6>
      </div>
      {
